  ...
  return (
    <section>
      <div ref={galerijaRef} className="scroll-link mb-20"></div>
          <div className="h-15 md:hidden bg-white w-full text-black flex items-center justify-center font-bold text-xl uppercase tracking-widest">{intl.formatMessage({id: "navbar.galerija"})}</div>
      <section className="flex md:items-stretch justify-center gap-0 md:px-10 px-0 w-full">
