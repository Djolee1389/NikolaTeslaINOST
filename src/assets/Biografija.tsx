  ...
  return (
    <section>
      ...
      <section>
        ...
        <button className="bg-transparent px-3 py-2 w-30 md:w-50 border border-white text-white hover:scale-110 md:py-3 md:px-5 transition-all duration-300 ease-in-out">
          <a
